var app = (function()
{
	...
	[
		{
            id: "region1",
            uuid: "FB6A2AC6-61CA-4AC2-9AAC-FA7251E6D58F",
            major: 784,
            minor: 596
		},
		{
			id: 'region2',
			uuid: '2DD9A0B0-AA78-11E7-ABC4-CEC278B6B50A',
			major: 378,
			minor: 881
		}
	];
	...
	function startMonitoringAndRanging()
	{
		...
		{
            console.log(" onDidDetermineStateForRegion ", result);
		...
		{
            console.log(" onDidRangeBeaconsInRegion ", result);
	...
	{
        console.log(" saveRegionEvent ", eventType, regionId);
		// Save event.
		mRegionEvents.push(
		{
			type: eventType,
	...
	{
        console.log(" getBeaconId ", beacon);
